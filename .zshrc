...
function up () {
  ...
  if ! brew upgrade --cask chatgpt chatgpt-atlas cursor dash discord figma raycast firefox github google-chrome hiddenbar itsycal keepingyouawake keka linear-linear loom maccy microsoft-auto-update microsoft-teams steam visual-studio-code warp whatsapp workflowy zoom; then
